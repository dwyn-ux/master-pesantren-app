...
- Name: security.spec.ts >> Access Control >> endpoint wali tidak bisa diakses tanpa auth
- Location: specs\security.spec.ts:81:7
...
Call log:
  - → GET https://app.ponpesashiddiq.or.id/wali/dashboard
