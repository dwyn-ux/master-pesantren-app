...
- Name: security.spec.ts >> Access Control >> SQL injection di login tidak berhasil
- Location: specs\security.spec.ts:114:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://app.ponpesashiddiq.or.id/login
Call log:
  - navigating to "https://app.ponpesashiddiq.or.id/login", waiting until "load"
