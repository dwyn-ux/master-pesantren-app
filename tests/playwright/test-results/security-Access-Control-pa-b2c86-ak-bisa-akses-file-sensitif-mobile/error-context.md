...
- Name: security.spec.ts >> Access Control >> path traversal tidak bisa akses file sensitif
- Location: specs\security.spec.ts:98:7
...
Call log:
  - → GET https://app.ponpesashiddiq.or.id/etc/passwd
