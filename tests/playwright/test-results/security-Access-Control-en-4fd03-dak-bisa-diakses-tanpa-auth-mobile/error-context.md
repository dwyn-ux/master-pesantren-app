...
- Name: security.spec.ts >> Access Control >> endpoint superadmin tidak bisa diakses tanpa auth
- Location: specs\security.spec.ts:93:7
...
Call log:
  - → GET https://app.ponpesashiddiq.or.id/superadmin/dashboard
    - user-agent: Mozilla/5.0 (Linux; Android 14; Pixel 7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.7778.96 Mobile Safari/537.36
    - accept: */*
