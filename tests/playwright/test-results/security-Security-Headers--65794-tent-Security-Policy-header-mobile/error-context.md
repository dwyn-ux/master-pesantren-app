...
- Name: security.spec.ts >> Security Headers >> response punya Content-Security-Policy header
- Location: specs\security.spec.ts:17:7
...
Call log:
  - → GET https://app.ponpesashiddiq.or.id/login
