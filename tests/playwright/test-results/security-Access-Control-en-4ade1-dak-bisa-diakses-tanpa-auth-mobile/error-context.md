...
- Name: security.spec.ts >> Access Control >> endpoint admin tidak bisa diakses tanpa auth
- Location: specs\security.spec.ts:66:7
...
Call log:
  - → GET https://app.ponpesashiddiq.or.id/admin/santri
